...
// //     <div className="page">
// //       <h1>Welcome to PDF Summarizer 👋</h1>
// //       <p>Transform your documents into concise summaries with AI</p>
...
// //           <div className="label">Powered</div>
// //         </div>
// //       </div>
...
// //           <span>📤</span>
// //           <h3>Upload PDF</h3>
// //           <p>Upload a document and get an AI-powered summary in seconds</p>
// //           <div className="card-arrow">Get Started →</div>
// //         </div>

// //         <div className="card" onClick={() => navigate('/history')}>
// //           <span>📋</span>
// //           <h3>View History</h3>
// //           <p>Access your previous summaries and manage your documents</p>
// //           <div className="card-arrow">View All →</div>
// //         </div>
// //       </div>
// //     </div>
// //   );
  ...
  return (
    <div className="page">
      <div className="home-hero">
        <h1>
          Welcome to <span>PDF Summarizer</span>
        </h1>
        <p>Transform your documents into concise summaries with AI</p>
      </div>
      ...
      <div className="home-cards">
        ...
        <div className="home-card" onClick={() => navigate('/history')}>
          <div className="icon">📋</div>
          <h3>View History</h3>
          <p>Access and manage your previous document summaries</p>
